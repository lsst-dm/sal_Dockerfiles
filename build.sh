...
export CCS_IDL_LIST="ATHeaderService ATCamera ATArchiver ATPtg MTPtg ATMCS ATSpectrograph ATHexapod Hexapod ATDome DIMM CCCamera CCArchiver CCHeaderService Environment"
